...
Текущая версия: **0.3.12**. Policy не допускает ручную ссылку или ручный набор меток в тексте патчноута: финальный Telegram footer добавляется ровно один раз. Добавлен read-only аудит уже опубликенных подписей. Стабильная версия до автоматизации сохранена в ветке [`stable/manual-publishing-v0.1.0`](https://github.com/sunpole/uNews/tree/stable/manual-publishing-v0.1.0).
