...
- `type` — тип публикации: `intro`, `patch`, `report`, `audit`, `note`, `docs`, `documentation`, `feature`, `bugfix`, `release`.
...
Для `type: patch`, `docs`, `documentation`, `audit`, `feature`, `bugfix` и `release` финальная подпись обязательно содержит слово “патч”, “обновление”, “релиз”, “документационное обновление”, “аудит” или “отчёт”. Если автор забыл это в коротком тексте, policy добавляет компактную вводную фразу автоматически.
