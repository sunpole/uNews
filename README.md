...
Текущая версия: **0.2.3**. Стабильная версия до автоматизации сохранена в ветке [`stable/manual-publishing-v0.1.0`](https://github.com/sunpole/uNews/tree/stable/manual-publishing-v0.1.0).
...
3. uNews проверяет очередь в `07, 22, 37, 52` минут каждого часа.
