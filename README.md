...
Текущая версия: **0.3.1**. Стабильная версия до автоматизации сохранена в ветке [`stable/manual-publishing-v0.1.0`](https://github.com/sunpole/uNews/tree/stable/manual-publishing-v0.1.0).
...
3. uNews просыпается раз в сутки или вручную; после успешного поста сам продолжает активную очередь с десятиминутной паузой.
