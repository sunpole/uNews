...
Текущая версия: **0.3.0**. Стабильная версия до автоматизации сохранена в ветке [`stable/manual-publishing-v0.1.0`](https://github.com/sunpole/uNews/tree/stable/manual-publishing-v0.1.0).
...
3. uNews адаптивно проверяет очередь: от четырёх раз в час после активности до одного раза в неделю при длительном простое.
